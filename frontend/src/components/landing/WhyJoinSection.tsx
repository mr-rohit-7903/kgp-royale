...
const WhyJoinSection = () => {
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/3 right-0 w-80 h-80 bg-[hsl(var(--secondary))] rounded-full mix-blend-multiply filter blur-[120px] opacity-10 animate-pulse [animation-delay:1s]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <p className="font-jakarta font-bold text-muted-foreground text-xl max-w-2xl mx-auto mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-75">
            Join the most elite Clash Royale community at IIT Kharagpur. Level up your game, make memories, and win big.
          </p>
          <div className="w-48 h-5 bg-primary mx-auto rounded-full border-4 border-foreground shadow-hard animate-pulse" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="bg-slate-50 border-2 border-slate-100 rounded-2xl p-4 font-jakarta font-bold text-muted-foreground leading-snug w-full">
                {benefit.description}
              </div>
            </div>
          ))}
          ...
          {/* Bonus CTA card */}
          <div 
            style={{ animationDelay: `${benefits.length * 75}ms` }}
            className="hidden lg:flex bg-primary border-4 border-foreground rounded-[2.5rem] shadow-soft-hard p-10 flex-col items-center justify-center text-center group hover:shadow-hard-hover hover:-translate-y-2 lg:translate-y-8 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8"
          >
