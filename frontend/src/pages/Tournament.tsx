    ...
    <div className="min-h-screen arena-bg pt-24 md:pt-28 pb-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <p className="text-lg md:text-xl text-muted-foreground animate-in fade-in slide-in-from-bottom-4 duration-500 delay-75">
        ...
        <div className="overflow-x-auto pb-4">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-4 min-w-[300px] lg:min-w-[900px]">
            ...
            {/* Connector */}
            <div className="hidden lg:flex items-center justify-center animate-in fade-in duration-500 delay-100">
              <span className="inline-flex items-center justify-center text-inherit">▶</span>
            </div>

            {/* Semi Finals */}
            <div className="flex-1 animate-in fade-in slide-in-from-left-4 duration-500 delay-150">
              <div className="text-center mb-4">
                <div className="inline-flex items-center gap-2 bg-secondary/50 px-4 py-2 rounded-xl border-2 border-border">
                  <span className="inline-flex items-center justify-center text-inherit">👑</span>
            ...
            {/* Connector */}
            <div className="hidden lg:flex items-center justify-center animate-in fade-in duration-500 delay-200">
              <span className="inline-flex items-center justify-center text-inherit">▶</span>
            </div>

            {/* Finals */}
            <div className="flex-1 animate-in fade-in slide-in-from-left-4 duration-500 delay-300">
              <div className="text-center mb-4">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-accent/20 to-gold-dark/20 px-4 py-2 rounded-xl border-2 border-accent animate-pulse-glow">
        ...
        {/* CTA */}
        <div className="text-center mt-12 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-500">
          <Link to="/upcoming">
            <Button variant="gold" size="lg" className="gap-3 group">
              <img src="/assets/Trophy.png" alt="Trophy" className="w-5 h-5 object-contain group-hover:rotate-12 transition-transform duration-300" />
              View Upcoming Tournaments
              <span className="inline-flex items-center justify-center text-inherit group-hover:translate-x-1 transition-transform duration-300">▶</span>
            </Button>
          </Link>
        </div>
      </div>
