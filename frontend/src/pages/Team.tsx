...
const Team = () => {
  return (
    <main className="min-h-screen py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[hsl(var(--primary))] rounded-full mix-blend-multiply filter blur-[120px] opacity-10 animate-pulse [animation-delay:1s]" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <p className="text-muted-foreground font-jakarta font-bold text-xl max-w-2xl mx-auto mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-75">
