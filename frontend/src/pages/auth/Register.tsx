...
const RegisterPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] flex items-center justify-center py-12 text-foreground">
      ...
      <div className="absolute bottom-[-10%] right-[-5%] w-80 h-80 bg-[hsl(var(--secondary))] rounded-full mix-blend-multiply filter blur-3xl opacity-50" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center order-1 lg:order-1 relative h-full min-h-[500px]">
            ...
            <div className="absolute w-[350px] h-[350px] bg-[hsl(var(--tertiary))] rounded-full border-4 border-foreground shadow-hard -z-10" />
            ...
            <div className="absolute bottom-12 left-8 w-10 h-10 bg-[hsl(var(--primary))] rounded-full border-2 border-foreground shadow-hard" />
            <div className="absolute top-16 right-4 w-12 h-12 bg-[hsl(var(--secondary))] transform rotate-12 border-2 border-foreground shadow-hard" />
          </div>
        </div>
      </div>
    </div>
